...
export default function Register() {
    ...
    const { data, setData, post, processing, errors, reset } = useForm<Required<RegisterForm> & { terms: boolean }>({
        name: '',
        email: '',
        password: '',
                        ...
                        <div className="grid gap-2">
                          <div className="flex items-center space-x-3">
                            ...
                            <Label htmlFor="terms" className="text-sm font-normal">
                              I agree to the{' '}
                              <TextLink href={route('terms.show')} target="_blank" tabIndex={6}>
                                Terms of Service
                              </TextLink>{' '}
                              and{' '}
                              <TextLink href={route('policy.show')} target="_blank" tabIndex={7}>
                                Privacy Policy
                              </TextLink>
                            </Label>
                          </div>
